  ...
  if (role === "adminbusiness") {
    return [
      { path: "/admin", label: "Dashboard", icon: "mdi:view-dashboard" },
      {
        ...
        icon: "streamline-freehand:discount-sale-sign",
      },
      {
        path: "/admin/discount-analytics",
        label: "Thống kê khuyến mãi",
        permission: "VIEW_DISCOUNT_ANALYTICS",
        icon: "mdi:chart-line",
      },
      {
        path: "/admin/orders",
