...
const ProductDetailPage = () => {
  ...
  if (!book)
    return <p className="p-4 text-gray-500">Đang tải dữ liệu sách...</p>;
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="mt-8">
        ...
        <ul className="text-gray-700 text-sm space-y-1">
          ...
          {book.originalPrice && (
            <li>
              <strong>Giá gốc:</strong> {book.originalPrice.toLocaleString()} đ
            </li>
          )}
          {book.sellingPrice && (
            <li>
              <strong>Giá bán:</strong> {book.sellingPrice.toLocaleString()} đ
            </li>
          )}
          ...
          {typeof book.averageRating === "number" && (
            <li>
              <strong>Đánh giá trung bình:</strong> {book.averageRating}/5
            </li>
          )}
          {typeof book.totalRatings === "number" && (
            <li>
              <strong>Số lượt đánh giá:</strong> {book.totalRatings}
            </li>
          )}
          {book.isFeatured && (
            <li>
              <strong>Phân loại:</strong> Sách nổi bật
            </li>
          )}
          {book.isNewArrival && (
            <li>
              <strong>Phân loại:</strong> Sách mới
            </li>
          )}
        </ul>
      </div>
